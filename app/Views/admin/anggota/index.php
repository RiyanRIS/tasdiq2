      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <!-- FORM Berkas -->
            <form method="post" action="tambah" data-refresh="refresh" data-url="<?= site_url("admin/berkas/tambah") ?>" id="myForm" enctype="multipart/form-data" accept-charset="utf-8" class="col-lg-4">
              <div class="card card-success">
