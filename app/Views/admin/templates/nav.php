  ...
  <div class="sidebar">
    ...
    <nav class="mt-2" id="nav">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= site_url('admin/berkas') ?>" data-nav="berkas" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?= site_url('admin/kampus') ?>" data-nav="kampus" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?= site_url('admin/galeri') ?>" data-nav="galeri" class="nav-link">
